                ...
                <div className="space-y-6">
                  ...
                  <div className="relative h-80 bg-gray-50 rounded-lg overflow-hidden">
                    <svg className="w-full h-full" viewBox="0 0 320 100">
                      ...
                      {/* Rangli bloklar */}
                      <rect x="240" y="8" width="70" height="24" rx="4" className="fill-green-50 stroke-green-200" />
                      <rect x="240" y="38" width="70" height="24" rx="4" className="fill-red-50 stroke-red-200" />
                      <rect x="240" y="68" width="70" height="24" rx="4" className="fill-green-50 stroke-green-200" />
                      <rect x="240" y="98" width="70" height="24" rx="4" className="fill-red-50 stroke-red-200" />
                      ...
                      {/* Natijalar matnlari */}
                      <text x="275" y="25" textAnchor="middle" className="text-xs font-medium text-green-700">Sud qarori</text>
                      <text x="275" y="55" textAnchor="middle" className="text-xs font-medium text-red-700">Rad etish</text>
                      <text x="275" y="85" textAnchor="middle" className="text-xs font-medium text-green-700">Kelishuv</text>
                      <text x="275" y="115" textAnchor="middle" className="text-xs font-medium text-red-700">Bekor qilish</text>
                    </svg>
                  </div>
