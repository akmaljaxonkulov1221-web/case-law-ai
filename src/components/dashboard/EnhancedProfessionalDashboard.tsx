            ...
            <div className="flex items-center gap-4">
              ...
              <Button variant="ghost" className="flex items-center gap-2">
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-gray-500">12-daraja</div>
                </div>
              </Button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-5 gap-4 mb-6">
            <Card className="bg-white border-gray-200 rounded-xl shadow-sm">
              <CardContent className="p-4">
                ...
                <div className="text-sm text-gray-600 mb-2">Daraja</div>
                <div className="space-y-1">
                  <Progress value={75} className="h-1" />
                  <div className="text-xs text-gray-500">550 XP keyingi darajagacha</div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white border-gray-200 rounded-xl shadow-sm">
              <CardContent className="p-4">
                ...
                <div className="text-sm text-gray-600 mb-2">G'alaba</div>
                <div className="text-xs text-gray-500">Davom eting!</div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white border-gray-200 rounded-xl shadow-sm">
              <CardContent className="p-4">
                ...
                <div className="text-sm text-gray-600 mb-2">Seriya</div>
                <div className="text-xs text-gray-500">Qayta ishlang!</div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white border-gray-200 rounded-xl shadow-sm">
              <CardContent className="p-4">
                ...
                <div className="text-sm text-gray-600 mb-2">Global reyting</div>
            ...
            <Card className="bg-white border-gray-200 rounded-xl shadow-sm">
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-xs text-green-600 font-medium">+2h</span>
                </div>
                <div className="text-2xl font-bold text-gray-900">156h</div>
                <div className="text-sm text-gray-600 mb-2">Vaqt</div>
                <div className="text-xs text-gray-500">Bu oy: 24h</div>
              </CardContent>
            </Card>
          </div>
                      ...
                      <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-gray-400">{case_.timeAgo}</div>
                          </div>
                        </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <Textarea
                        ...
                        className="min-h-[100px] mb-3 pr-10"
                      />
                    ...
                    <svg className="w-full h-full" viewBox="0 0 300 100">
                      ...
                      {decisionTreeNodes.map((node) => 
                        node.connections.map((targetId) => {
                          ...
                          const midY = (node.y + target.y) / 2 + 5
                          return (
                            <path
                      ...
                      {/* Rangli bloklar */}
                      <rect x="230" y="10" width="60" height="20" rx="4" className="fill-green-100" />
                      <rect x="230" y="35" width="60" height="20" rx="4" className="fill-red-100" />
                      <rect x="230" y="60" width="60" height="20" rx="4" className="fill-green-100" />
                      <rect x="230" y="85" width="60" height="20" rx="4" className="fill-red-100" />
                      ...
                      {/* Natijalar matnlari */}
                      <text x="260" y="25" textAnchor="middle" className="text-xs font-medium text-green-700">Sud qarori</text>
                      <text x="260" y="50" textAnchor="middle" className="text-xs font-medium text-red-700">Rad etish</text>
                      <text x="260" y="75" textAnchor="middle" className="text-xs font-medium text-green-700">Kelishuv</text>
                      <text x="260" y="100" textAnchor="middle" className="text-xs font-medium text-red-700">Bekor qilish</text>
                    </svg>
                  </div>
