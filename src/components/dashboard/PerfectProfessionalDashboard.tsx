...
export default function PerfectProfessionalDashboard() {
          ...
          <div className="grid grid-cols-5 gap-4 mb-8">
            <Card className="bg-white border-gray-200 rounded-xl shadow-sm">
              <CardContent className="p-6">
                ...
                <div className="text-sm text-gray-600 mb-3">Daraja</div>
                <div className="space-y-2">
            ...
            <Card className="bg-white border-gray-200 rounded-xl shadow-sm">
              <CardContent className="p-6">
                ...
                <div className="text-sm text-gray-600 mb-3">G'alaba</div>
            ...
            <Card className="bg-white border-gray-200 rounded-xl shadow-sm">
              <CardContent className="p-6">
                ...
                <div className="text-sm text-gray-600 mb-3">Seriya</div>
            ...
            <Card className="bg-white border-gray-200 rounded-xl shadow-sm">
              <CardContent className="p-6">
                ...
                <div className="text-sm text-gray-600 mb-3">Global reyting</div>
            ...
            <Card className="bg-white border-gray-200 rounded-xl shadow-sm">
              <CardContent className="p-6">
                ...
                <div className="text-sm text-gray-600 mb-3">Vaqt</div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="relative h-80 bg-gray-50 rounded-lg overflow-hidden">
                    <svg className="w-full h-full" viewBox="0 0 300 100">
                      ...
                      {/* Rangli bloklar */}
                      <rect x="220" y="8" width="70" height="24" rx="4" className="fill-green-50 stroke-green-200" />
                      <rect x="220" y="38" width="70" height="24" rx="4" className="fill-red-50 stroke-red-200" />
                      <rect x="220" y="68" width="70" height="24" rx="4" className="fill-green-50 stroke-green-200" />
                      <rect x="220" y="98" width="70" height="24" rx="4" className="fill-red-50 stroke-red-200" />
                      ...
                      {/* Natijalar matnlari */}
                      <text x="255" y="25" textAnchor="middle" className="text-xs font-medium text-green-700">Sud qarori</text>
                      <text x="255" y="55" textAnchor="middle" className="text-xs font-medium text-red-700">Rad etish</text>
                      <text x="255" y="85" textAnchor="middle" className="text-xs font-medium text-green-700">Kelishuv</text>
                      <text x="255" y="115" textAnchor="middle" className="text-xs font-medium text-red-700">Bekor qilish</text>
                    </svg>
                  </div>
